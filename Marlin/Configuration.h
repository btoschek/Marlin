...
#define STRING_CONFIG_H_AUTHOR "(Bastian Toschek, Ender-3 Pro)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 98.4 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45.5, -5, -0.89 }
